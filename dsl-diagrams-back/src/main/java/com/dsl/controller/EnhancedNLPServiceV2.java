...
public class EnhancedNLPServiceV2 {
    ...
    public EnhancedNLPServiceV2(NLPService basicNLPService, StanfordNLPService stanfordNLPService) {
        ...
        this.stanfordNLPService = stanfordNLPService;w
    }
    ...
    private NLPResult enhanceWithStanfordNLP(String message, NLPResult basicResult, NLPResult huggingFaceResult, UserContext context) {
        ...
        String finalIntent = chooseBestIntent(basicResult, stanfordResult, huggingFaceResult, context);
    ...
    private String chooseBestIntent(NLPResult basicResult, StanfordNLPResult stanfordResult, NLPResult huggingFaceResult, UserContext context) {
        if (huggingFaceResult != null && huggingFaceResult.getConfidence() > 0.8) {
            return huggingFaceResult.getIntent();
        }
        ...
        if (stanfordResult.getIntentConfidence() >= 0.7) {
